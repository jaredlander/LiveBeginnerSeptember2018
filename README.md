...
organized by
[O’Reilly](https://www.safaribooksonline.com/live-training/courses/beginning-r-programming/0636920214311/).
...
``` r
newProject <- usethis::use_course('https://github.com/jaredlander/LiveBeginnerSeptember2018/archive/master.zip')
```
...
LiveBeginnerSeptember2018. You can see this in the top right of RStudio
